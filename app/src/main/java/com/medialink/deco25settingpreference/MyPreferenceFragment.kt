package com.medialink.deco25settingpreference
...
class MyPreferenceFragment : PreferenceFragmentCompat(),
    ...
    private fun setSummaries() {
        ...
        namePreference.summary = pref.getString(NAME, DEFAULT_VALUE)
        emailPreference.summary = pref.getString(EMAIL, DEFAULT_VALUE)
        agePreference.summary = pref.getString(AGE, DEFAULT_VALUE)
        phonePreference.summary = pref.getString(PHONE, DEFAULT_VALUE)
        isLoveMuPreference.isChecked = pref.getBoolean(LOVE, false)
    }
